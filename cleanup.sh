...
then
	...
	# kubectl delete chaosengines.litmuschaos.io --all -n hce
	echo " Deleting ChaosResults"
	kubectl delete chaosresults.litmuschaos.io --all -n hce
	echo " Deleting ChaosExperiments"
	kubectl delete chaosexperiments.litmuschaos.io --all -n hce
	echo " Deleting HCE Namespace"
	kubectl delete ns hce
